# War of Kings - Master Autonomy Brief for 

Paste this into  as your first message after you've cloned the repo. It tells you what autonomy you have, what you don't, where to get every asset, how to handle every category of work, and how to keep me (the human director) in the loop without blocking on me.

This brief assumes you have read `NOTES.md`, `README.md`, and the five documents under `docs/`. If you haven't, read them now before proceeding.
