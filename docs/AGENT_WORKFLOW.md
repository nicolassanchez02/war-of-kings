...
When  reports a milestone closed, don't just take its word. Spend ~20 minutes calibrating before authorizing the next milestone. This is also the first thing to run after every M-checklist commit lands on `main`.
...
These are install/toolchain quirks and architectural observations that future-you (or future ) will hit again. They don't belong in chat — chat evaporates. They don't belong in source comments — most of them aren't about any one file. They live here so they survive.
